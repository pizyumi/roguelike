...
obj = _.extend(obj, {
    get: async () => {
        ...
        app.get('/get-names', (req, res, next) => {
            co(function* () {
                var data = req.query;
                var p = path.join(__dirname, 'record', data.version);
        ...
        app.get('/get-records', (req, res, next) => {
            co(function* () {
                var data = req.query;
                var p = path.join(__dirname, 'record', data.version, data.name);
        ...
        app.get('/get-record', (req, res, next) => {
            co(function* () {
                var data = req.query;
                var p = path.join(__dirname, 'record', data.version, data.name, data.record + '.json');
        ...
        app.post('/add-record', (req, res, next) => {
            co(function* () {
                ...
                var p = path.join(__dirname, 'record', record.version, sanitizefilename(record.name), record.id + '.json');
